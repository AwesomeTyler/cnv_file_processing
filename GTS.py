...
CNVfile = '2021-020-0133.cnv'
dest = '/Users/tylerzhang/Desktop/CNV/'
dest_file = dest + CNVfile           #Completer File Destination
...
Header_Hold = {'Depth': depSM, 'Pressure': prDM, 'Temperature': t090C, 'Oxygen': sbeox, 'Salinity':derived_salinity, 'Conductivity': c0}
...
lat = profile.attributes['LATITUDE']
...
#print(Binned_dta.Depth.calues)         #List all depth and maunally depth selection
...
Section3 = str('CGBW =')          #Ship Callsign
#Section3 = str('CG2958 =')           #line P call sign
